...
<div className="max-w-sm ml-0">
  <label htmlFor="category-options" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
    {t("detailscategory")}
  </label>
  <select
    id="category-options"
    ...
    required
  >
    <option value="">{t("detailscategory")}</option> {/* Placeholder */}
    {categories?.map((cat) => (
...
<div>
  <label className="block mb-2">{t("detailsimages")}</label>
...
<div className="mt-8">
  <label className="block mb-2">{t("detailsvideo")}</label>
